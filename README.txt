...
WPF application named HidDemoWpf
...
hid.cs offers a nice, truely C# interface that lets you communicate to HID devices. Basically all you need to do is to create an instance of HidUtility and subscribe to the events you're interested in. The 3 application should give you a good starting point.
